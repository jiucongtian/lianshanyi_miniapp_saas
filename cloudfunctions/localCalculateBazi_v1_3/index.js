...
exports.main = async (event, context) => {
  ...
  try {
    console.log('=== localCalculateBazi_v1_3 云函数开始执行 ===');
    ...
    if (isLunar) {
      ...
      const calendar = require('./core-converter/js-calendar-converter-v2');
    ...
    console.error('localCalculateBazi_v1_3 执行失败:', error);
