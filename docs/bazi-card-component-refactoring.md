...
### 阶段三：页面集成与显示验证（1小时）⭐️ 重要验证点

- [ ] **Task 3.1** - 修改 `pages/card/index.json`，添加组件引用
  ```json
  "usingComponents": {
